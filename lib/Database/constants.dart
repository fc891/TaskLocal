...
const MONGO_CUSTOMER_COLLECTION = "customer"; //Customer database/collection name
const MONGO_TASKER_COLLECTION = "tasker"; //Tasker database/collection name

//Test user details:
//username: test_user
//password: fkgSzO9Ox62v3zNI

//Connection url (replace <username> and <password>, "< and > included"):
//mongodb+srv://<username>:<password>@tasklocal.y7njlqc.mongodb.net/